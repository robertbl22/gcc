...
.directive('corridorMap', function(LocalDataProvider_CorridorsSvc, ColorSvc, GoogleMapSvc) {
	return {
		restrict: 'A',
		...
		link: function(scope, element, attrs) {
			...
			LocalDataProvider_CorridorsSvc.get(scope.corridorId).success(function(data) {
