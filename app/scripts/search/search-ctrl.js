...
.controller('SearchCtrl', function ($scope, CountiesSvc, SearchSvc, ToastrSvc) {

	$scope.Search = SearchSvc.fields;
	$scope.Form = {'Property': {}};

	CountiesSvc.get().success(function(data) {
		$scope.Counties = data;
	});
	...
	$scope.$watch('Search.Property.Type', function() {
		switch($scope.Search.Property.Type) {
			case 'Site': 
			$scope.Form.Property.TemplateUrl = 'scripts/search/subforms/site.html';
			break;
			case 'OfficeBuilding': 
			$scope.Form.Property.TemplateUrl = 'scripts/search/subforms/office.html';
			break;
			case 'IndustrialBuilding': 
			$scope.Form.Property.TemplateUrl = 'scripts/search/subforms/industrial.html';
			break;
		}
	});
