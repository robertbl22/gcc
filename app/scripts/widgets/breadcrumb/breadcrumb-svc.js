...
.factory('BreadcrumbSvc', function ($q, LocalDataProvider_CorridorsSvc, LocalDataProvider_CountiesSvc, PropertySvc) {
	...
	var getCorridorCrumb = function(corridorId, previousPath) {
		...
		LocalDataProvider_CorridorsSvc.get(corridorId).success(function(data) {
	...
	var getCountyCrumb = function(countyId, previousPath) {
		var deferred = $q.defer();
		LocalDataProvider_CountiesSvc.get(countyId).success(function(data) {
			deferred.resolve(function() {
