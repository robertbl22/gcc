...
.factory('BreadcrumbSvc', function ($q, CorridorsSvc, CountiesSvc, PropertySvc) {
	...
	var getCorridorCrumb = function(corridorId, previousPath) {
		...
		CorridorsSvc.get(corridorId).success(function(data) {
	...
	var getCountyCrumb = function(countyId, previousPath) {
		var deferred = $q.defer();
		CountiesSvc.get(countyId).success(function(data) {
			deferred.resolve(function() {
